...
let data = [
  {
    ...
    body:
      `<div>
        ...
        <p>
        Slow-carb cliche farm-to-table 8-bit echo park. Offal cronut cold-pressed try-hard. Quinoa retro selfies, disrupt paleo ugh 3 wolf moon chambray kale chips drinking vinegar polaroid chia celiac YOLO. Chambray direct trade organic, retro letterpress pitchfork pour-over artisan swag scenester tattooed you probably haven't heard of them echo park. Everyday carry aesthetic kombucha 3 wolf moon readymade. Cornhole austin polaroid, beard fap portland single-origin coffee tilde raw denim kombucha ennui cliche. Lo-fi twee organic gluten-free forage, poutine disrupt four dollar toast shoreditch.
        </p>
        <p>
